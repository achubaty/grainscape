...
This outlines how to propose a change to grainscape. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("achubaty/grainscape", fork = TRUE)`.
...
- Create a Git branch for your pull request (PR). We recommend using
  `usethis::pr_init("brief-description-of-change")`. Active development
  happens on the `development` branch, so please target your PR there
  rather than `main`.
...
- New code should follow the tidyverse [style
  guide](https://style.tidyverse.org), with one exception: object names
  use **camelCase**. Run [Air](https://posit-dev.github.io/air/)
  (`air format .`) to apply formatting, but please don’t restyle code
...
Code of
Conduct](https://www.alexchubaty.com/grainscape/CODE_OF_CONDUCT.md). By
