...
- `ActiveCellQueue`: contains an `ActiveCellHolder`. Its main purpose is to properly store the `ActiveCellHolder` in a vector in order of increasing Euclidean distance.
...
```{r call_graph_engine_initialize, echo = FALSE,  fig.cap = "Call diagram for Engine::initialize()"}
DiagrammeR::grViz("
  digraph initialize {
...
```{r call_graph_engine_start, echo = FALSE, fig.cap = "Call diagram for Engine::start()"}
DiagrammeR::grViz("
  digraph start {
    graph [overlap = true, fontsize = 10]
