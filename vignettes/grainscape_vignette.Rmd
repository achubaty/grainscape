...
![Spatial network modelling with `grainscape`. Numerals refer to figures.](figure_partA.png){ width=95% }

![Scaling of spatial networks with `grainscape`. Numerals refer to figures.](figure_partB.png){ width=95% }
...
ggsave("figure_partA.png", plot = partA, width = 8, height = 8, dpi = 600) 
```
...
ggsave("figure_partB.png", plot = partB, width = 8, height = 8, dpi = 600) 
```
