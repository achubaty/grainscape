...
opts_chunk$set(fig.path = "images/figure_")
...
![Spatial network modelling with `grainscape`. Numerals refer to figures.](images/partA.png){ width=95% }

![Scaling of spatial networks with `grainscape`. Numerals refer to figures.](images/partB.png){ width=95% }
...
```{r, figure_09, fig.cap="A planar network with one-dimensional point nodes extracted using `grainscape`. Nodes are represented as points and labelled with their `patchId`. Links are line segments among nodes."}
