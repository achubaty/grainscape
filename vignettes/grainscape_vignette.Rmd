...
![Spatial network modelling with `grainscape`. Numerals refer to figures.](figure_partA.png){ width=90% }

\newpage

![Scaling of spatial networks with `grainscape`. Numerals refer to figures.](figure_partB.png){ width=90% }
